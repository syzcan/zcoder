	...
	<div class="admin">
		<div class="panel admin-panel">
			<div class="panel-head" id="buttonList">
				数据连接：【<a href="${ctx}/${dbname}/tables">${dbname }</a> > ${tableName }<c:if test="${empty table.primary}"><strong class="text-red">【无主键】 </strong></c:if>
				...
				objectName：<input id="objectName" type="text" class="input input-auto border-main" value="${table.objectName }">
