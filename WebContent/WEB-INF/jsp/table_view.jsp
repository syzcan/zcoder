				...
				<tbody id="dataList" class="table-bordered table-condensed">
					<c:forEach items="${columns }" var="column" varStatus="vs">
						<tr>
							...
							<td class="beanField"><input type="text" class="formInput" readonly="readonly" data-field="${column.field }" data-type="${column.type }" data-required="${column.canNull=='NO'}"/></td>
							...
							<td class="text-blue">${column.type }</td>
