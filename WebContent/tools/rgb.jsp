...
<div class="row">
	...
	<div class="col-md-12">
		<div class="panel panel-default">
			...
			<strong style="font-size: 16px"><i class="fa fa-cogs"></i> RGB转16进制工具</strong>
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="input-group input-group-lg">
			         <span class="input-group-addon">红(R:0~255)</span>
			         <input type="text" class="form-control red" value="117">
			      </div><br>
                  <div class="input-group input-group-lg">
			         <span class="input-group-addon">绿(G:0~255)</span>
			         <input type="text" class="form-control green" value="216">
			      </div><br>
			      <div class="input-group input-group-lg">
			         <span class="input-group-addon">蓝(B:0~255)</span>
			         <input type="text" class="form-control blue" value="96">
			      </div><br>
			      <div class="input-group input-group-lg" style="display: none">
			         <span class="input-group-addon">透明度(A：0~255)</span>
                  ...
                  <div style="margin: 20px 100px;">
                    <div class="panel panel-success panel-color">
                    	<div class="panel-heading" style="padding: 0;">
                    	 <div class="input-group input-group-lg">
                    	<span class="input-group-addon">HEX 值</span>
                    	 <input type="text" class="form-control hex-value" value="#b1d85c">
                    	 </div>
					      
					   </div>
					  
					   <div class="panel-body" style="background-color: #b1d85c">
					     <br><br><br><br><br>
					   </div>
					</div>
                  </div>
