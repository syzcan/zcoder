				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="input-group">
							<span class="input-group-addon" id="basic-addon1">加密前</span> <input type="text" class="form-control" id="str" placeholder="要加密的文本" aria-describedby="basic-addon1">
						</div>
						<div class="input-group" style="margin-top: 20px;">
							<span class="input-group-addon" id="basic-addon1">加密后</span> <input type="text" class="form-control" id="estr" placeholder="加密后的文本" aria-describedby="basic-addon1">
						</div>
